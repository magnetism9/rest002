            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#1a3a8f]/10 border border-[#1a3a8f]/20 rounded-xl p-4 mt-6">
                ...
                <div className="space-y-1 text-sm text-[#64748b]">
                  ...
                  <div className="flex justify-between text-[#94a3b8]"><span>일요일/공휴일</span><span>휴무</span></div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border border-[#e2e8f0] p-8">
              {submitted ? (
                <div className="flex flex-col items-center justify-center h-full py-16 text-center">
                  ...
                  <p className="text-[#64748b] text-sm">빠른 시일 내에 연락드리겠습니다.</p>
                  <button
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-[#374151] mb-1.5">성함 <span className="text-[#991b1b]">*</span></label>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-[#374151] mb-1.5">연락처 <span className="text-[#991b1b]">*</span></label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#374151] mb-1.5">문의 유형 <span className="text-[#991b1b]">*</span></label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#374151] mb-1.5">문의 내용 <span className="text-[#991b1b]">*</span></label>
